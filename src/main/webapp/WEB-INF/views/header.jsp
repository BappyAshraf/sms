...
<%@taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
				...
				<div class="logo-container">
					<%-- <a href="/sms/" class="logo">
							<img src="<c:url value="/resources/images/BRTA.png" />" height="50" alt="BRTA" style="margin-top:-10px"/>
					</a> --%>
					...
					<div id="userbox" class="userbox" style="float:right">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="/sms/user/changePassword"><i class="fa fa-refresh"></i> Password Change</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="/sms/logout.html"><i class="fa fa-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
