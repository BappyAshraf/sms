...
<body>
	...
	<section class="body-sign">
		...
		<div class="center-sign">
			<a href="/sms/" class="logo pull-left"> <img
				src="<c:url value="/resources/images/!happy-face.png" />"
				height="80" alt="SMS" style="margin-top: -31px" />
			</a>
			...
			<div class="panel panel-sign">
				...
				<div class="panel-body">
					<form modelAttribute="loginInfo" action="/sms/validateUser"
						method="post">
			...
			<p class="text-center text-muted mt-md mb-md">&copy; All Right
				Reserved by ASHRAF IT Ltd. 2017</p>
		</div>
	</section>
	<!-- end: page -->
